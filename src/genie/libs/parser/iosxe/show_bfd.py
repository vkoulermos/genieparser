...
class ShowBfdNeighborsSchema(MetaParser):
  schema = {
    "sessions": {
      str: {
        "ld_rd": str,
...
class ShowBfdNeighbors(ShowBfdNeighborsSchema):
  """
  Parser for 'show bfd neighbors'
  """
  cli_command = 'show bfd neighbors'
